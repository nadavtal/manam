...
import { menus } from '../MegaMenu/menu-templates';
...
const SideMenu = ({
  ...
  return <div 
    className={showSideMenu ? 'wsactive' : ''}
    >
    {/* <!-- Mobile Header --> */}
    <div className="wsmobileheader clearfix">
      <span id="wsnavtoggle" className="wsanimated-arrow"
        onClick={toggleSideNav}><span></span></span>
      <span className="smllogo"><img src={require('../../images/manamapps_logo_300x100.png')}/></span>
      <span id="wsnavtoggle02" className="wsanimated-arrow02"><span></span></span>
    </div>
    {/* <!-- Mobile Header --> */}
      ...
      <div className="wsmenu02-list">
        ...
        <div className="wsmenu02text clearfix">
          <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
            ...
            more recentlywith desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. orem
            Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry</p>
          <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
            industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and
            scrambled it to make a type
            specimen book.It has survived not only five centuries, but also the leap into electronic typesetting,
            ...
            more recentlywith desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. orem
            Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry</p>
          <p>Lorem Ipsum is simply dummy text of the printing and specimen book. It has survived not only five
            centuries,cluding versions of Lorem Ipsum.</p>
    ...
    <nav className="wsmenu clearfix">
      <div className="overlapblackbg" onClick={toggleSideNav}></div>
      <CSSTransition
        in={showSideMenu}
        timeout={300}
